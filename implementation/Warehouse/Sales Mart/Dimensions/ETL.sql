...
FROM 'D:\IUT\400-2\DB2\proj\implementation\Warehouse\Sales Mart\Dimensions\sample data for Date Dimension\Date.txt'
WITH (
    fieldterminator = '\t',
    ROWTERMINATOR= '\n'
)
...
bulk INSERT [DataWarehouse].[dbo].[Dim_Date]
FROM 'D:\IUT\400-2\DB2\proj\implementation\Warehouse\Sales Mart\Dimensions\sample data for Date Dimension\Date.csv'
WITH (
    fieldterminator = ',',
    ROWTERMINATOR= '\n'
)
